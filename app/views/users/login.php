        ...
        <div class="grid grid-cols-2 p-6">
            <div class="w-full">
                ...
                <form action="<?= URLROOT . '/Users/login'?>" method="POST"
                    class="flex flex-col justify-center  gap-4 xl:w-2/3">
                    ...
                    <button class="bg-blue-300 rounded-xl border py-2 w-1/2 hover:scale-110"><a
                            href="<?= URLROOT . '/Products/product'?>">LOGIN</a></button>
            ...
            <div class="sm:block hidden w-full">
                <img class="rounded-2xl " src="http://localhost/glowguru/public/images//bg-prd (1).png"
                    alt="login Image">
            </div>
