...
<div class="flex flex-row w-full my-10 xl:mb-20">
    ...
    <div class="grid grid-cols-4 ">
        ...
        <img src="http://localhost/glowguru/public/images//partners/avon.png" alt="Avon logo" class="mt-6 ml-4 xl:mx-10 w-3/4 xl:mt-36" >
        <img src="http://localhost/glowguru/public/images//partners/bourjois.png" alt="Avon logo" class="xl:mx-10 w-3/4 xl:mt-4">
        <img src="http://localhost/glowguru/public/images//partners/loreal.png" alt="Avon logo" class="xl:mx-10 w-3/4">
        <img src="http://localhost/glowguru/public/images//partners/shein.png" alt="Avon logo" class="mt-4 xl:mx-10 w-3/4 xl:mt-20">
...
<footer class="p-2 bg-white rounded-lg shadow md:px-6 md:py-4 dark:bg-gray-900">
  ...
  <div class="sm:flex sm:items-center sm:justify-between">
      ...
      <ul class="flex flex-wrap xl:items-center justify-center ml-5 mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
  ...
  <span class=" flex xl:items-center  justify-center block text-sm text-gray-500 sm:text-center dark:text-gray-400">©<a href="https://flowbite.com/" class="hover:underline">GlowGuru™ </a>. All Rights Reserved.
  </span>
</footer>
